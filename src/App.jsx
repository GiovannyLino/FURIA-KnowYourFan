...
import CreateAccount from './components/CreateAccount'; // Importando a página de Criar Conta
import Perfil from './pages/Perfil'; // Importando a página de Perfil
      ...
      <div className="w-full overflow-y-auto snap-y snap-mandatory">
        ...
        {isAuthenticated() && (
          <button
            ...
            className="absolute top-5 right-5 p-2 bg-red-600 text-white rounded hover:bg-red-700"
          >
            Sair
          </button>
        )}
        ...
        <Routes>
          ...
          {/* Página principal (apenas se o usuário estiver autenticado) */}
          <Route 
            path="/" 
            element={
              isAuthenticated() ? (
